...
from novabot.core.utils.novabot_path import get_novabot_skills_path
...
class NeoSkillSyncManager:
    ...
    def __init__(
        ...
        *,
        ...
        self.skills_root = skills_root or get_novabot_skills_path()
    ...
    async def sync_release(
        ...
        *,
        ...
        # Ensure local skill is visible to NovaBot skill manager.
