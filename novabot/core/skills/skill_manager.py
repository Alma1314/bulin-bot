...
def build_skills_prompt(skills: list[SkillInfo]) -> str:
    ...
    return (
        ...
        "(one short line). Prefer `novabot_*` tools when running skill "
        "scripts.\n"
...
class SkillManager:
    def __init__(
        ...
        self.plugins_root = plugins_root or get_novabot_plugin_path()
        data_path = Path(get_novabot_data_path())
    ...
    def install_skill_from_zip(
        ...
        *,
        ...
        with zipfile.ZipFile(zip_path) as zf:
            ...
            with tempfile.TemporaryDirectory(dir=get_novabot_temp_path()) as tmp_dir:
