...
from novabot.core import novabot_config, logger, sp
from novabot.core.novabot_config_mgr import NovaBotConfigManager
from novabot.core.db import BaseDatabase
from novabot.core.utils.error_redaction import safe_error
...
class ProviderManager:
    ...
    async def reload(self, provider_config: dict) -> None:
        async with self.reload_lock:
            ...
            # 和配置文件保持同步
            self.providers_config = novabot_config["provider"]
            self.provider_sources_config = novabot_config.get("provider_sources", [])
