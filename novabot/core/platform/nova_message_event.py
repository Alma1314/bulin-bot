...
from novabot.core.db.po import Conversation
...
from novabot.core.utils.trace import TraceSpan

from .novabot_message import NovaBotMessage, Group
from .message_session import MessageSesion, MessageSession  # noqa
from .platform_metadata import PlatformMetadata


class NovaMessageEvent(abc.ABC):
    def __init__(
        self,
        message_str: str,
    ...
    def set_result(self, result: MessageEventResult | str) -> None:
        ...
        Example:
        ```
        async def ban_handler(self, event: NovaMessageEvent):
        ...
        async def check_count(self, event: NovaMessageEvent):
            self.count += 1
    ...
    def should_call_llm(self, call_llm: bool) -> None:
        ...
        只会阻止 NovaBot 默认的 LLM 请求链路，不会阻止插件中的 LLM 请求。
        """
