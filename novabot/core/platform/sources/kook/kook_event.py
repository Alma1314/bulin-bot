...
from novabot.core.platform import MessageType
...
class KookEvent(NovaMessageEvent):
    def __init__(
        self,
        message_str: str,
        ...
        self.novabot_message_type: MessageType = message_obj.type
