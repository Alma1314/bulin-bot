...
from novabot.api.message_components import File, Image, Json, Plain, Record
from novabot.core.utils.novabot_path import get_novabot_data_path

from .webchat_queue_mgr import webchat_queue_mgr

attachments_dir = os.path.join(get_novabot_data_path(), "attachments")
...
class WebChatMessageEvent(NovaMessageEvent):
