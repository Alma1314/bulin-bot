...
from novabot.api.message_components import At, File, Json, Plain, Record, Video
from novabot.api.message_components import Image as NovaBotImage
...
class LarkMessageEvent(NovaMessageEvent):
    def __init__(
        self,
        message_str,
        message_obj,
    ...
    async def _convert_to_lark(message: MessageChain, lark_client: lark.Client) -> list:
        ...
        for comp in message.chain:
            ...
            elif isinstance(comp, NovaBotImage):
                file_path = ""
                image_file = None
