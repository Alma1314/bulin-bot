...
from novabot.api.message_components import File, Image, Plain, Record, Reply, Video
...
class WeixinOCAdapter(Platform):
    ...
    async def _save_account_state(self) -> None:
        ...
        for platform in novabot_config.get("platform", []):
    ...
    def _resolve_inbound_media_dir(self) -> Path:
        media_dir = Path(get_novabot_temp_path())
