...
from novabot.core.knowledge_base.retrieval.sparse_retriever import SparseResult
        ...
        for identifier in sorted_ids:
            ...
            if identifier in chunk_id_to_sparse:
                ...
                try:
                    ...
                    continue
                required_keys = ("chunk_index", "kb_doc_id", "kb_id")
                if not all(k in chunk_md for k in required_keys):
                    continue
                fused_results.append(
                    FusedResult(
                        chunk_id=identifier,
