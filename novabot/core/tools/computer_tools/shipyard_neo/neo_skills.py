...
from novabot.api import FunctionTool
...
from novabot.core.skills.neo_skill_sync import NeoSkillSyncManager
...
class GetExecutionHistoryTool(NeoSkillToolBase):
    name: str = "novabot_get_execution_history"
...
class AnnotateExecutionTool(NeoSkillToolBase):
    name: str = "novabot_annotate_execution"
...
class CreateSkillPayloadTool(NeoSkillToolBase):
    name: str = "novabot_create_skill_payload"
    description: str = (
...
class GetSkillPayloadTool(NeoSkillToolBase):
    name: str = "novabot_get_skill_payload"
...
class CreateSkillCandidateTool(NeoSkillToolBase):
    name: str = "novabot_create_skill_candidate"
    description: str = (
    ...
    parameters: dict = field(
        default_factory=lambda: {
            ...
            "properties": {
                ...
                "payload_ref": {
                    "type": "string",
                    "description": "Optional payload reference created by novabot_create_skill_payload.",
                },
            },
...
class ListSkillCandidatesTool(NeoSkillToolBase):
    name: str = "novabot_list_skill_candidates"
...
class EvaluateSkillCandidateTool(NeoSkillToolBase):
    name: str = "novabot_evaluate_skill_candidate"
...
class PromoteSkillCandidateTool(NeoSkillToolBase):
    name: str = "novabot_promote_skill_candidate"
    description: str = (
...
class ListSkillReleasesTool(NeoSkillToolBase):
    name: str = "novabot_list_skill_releases"
...
class RollbackSkillReleaseTool(NeoSkillToolBase):
    name: str = "novabot_rollback_skill_release"
...
class SyncSkillReleaseTool(NeoSkillToolBase):
    name: str = "novabot_sync_skill_release"
    description: str = (
