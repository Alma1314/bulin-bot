...
async def _get_browser_component(context: ContextWrapper[NovaAgentContext]) -> Any:
...
class BrowserExecTool(FunctionTool):
    name: str = "novabot_execute_browser"
...
class BrowserBatchExecTool(FunctionTool):
    name: str = "novabot_execute_browser_batch"
...
class RunBrowserSkillTool(FunctionTool):
    name: str = "novabot_run_browser_skill"
