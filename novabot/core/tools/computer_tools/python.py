...
from novabot.core.nova_agent_context import NovaAgentContext, NovaMessageEvent
from novabot.core.computer.computer_client import get_booter, get_local_booter
...
async def handle_result(result: dict, event: NovaMessageEvent) -> ToolExecResult:
...
class PythonTool(FunctionTool):
    name: str = "novabot_execute_ipython"
...
class LocalPythonTool(FunctionTool):
    name: str = "novabot_execute_python"
    description: str = (
