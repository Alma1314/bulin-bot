...
_BUILTIN_TOOL_MODULES = (
    "novabot.core.tools.computer_tools",
    "novabot.core.tools.cron_tools",
    "novabot.core.tools.knowledge_base_tools",
    "novabot.core.tools.message_tools",
    "novabot.core.tools.web_search_tools",
)
