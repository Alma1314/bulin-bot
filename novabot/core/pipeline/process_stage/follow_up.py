...
from novabot.core.agent.runners.tool_loop_agent_runner import FollowUpTicket
...
def _event_follow_up_text(event: NovaMessageEvent) -> str:
...
def try_capture_follow_up(event: NovaMessageEvent) -> FollowUpCapture | None:
