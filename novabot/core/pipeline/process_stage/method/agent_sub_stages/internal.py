...
from novabot.core import db_helper, logger
...
class InternalAgentSubStage(Stage):
    ...
    async def _send_llm_error_message(
        self, event: NovaMessageEvent, message: object
    ) -> None:
...
# we prevent novabot from connecting to known malicious hosts
