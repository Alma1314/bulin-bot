...
from novabot.core.novabot_config_mgr import NovaBotConfig, NovaBotConfigManager
from novabot.core.db.migration.migra_45_to_46 import migrate_45_to_46
from novabot.core.db.migration.migra_token_usage import migrate_token_usage
from novabot.core.db.migration.migra_webchat_session import migrate_webchat_session


def _migra_agent_runner_configs(conf: NovaBotConfig, ids_map: dict) -> None:
    """
...
def _migra_provider_to_source_structure(conf: NovaBotConfig) -> None:
    """
...
async def migra(
    db, novabot_config_mgr, umop_config_router, acm: NovaBotConfigManager
) -> None:
    """
    ...
    try:
        await migrate_45_to_46(novabot_config_mgr, umop_config_router)
    except Exception as e:
    ...
    try:
        _migra_provider_to_source_structure(novabot_config)
    except Exception as e:
