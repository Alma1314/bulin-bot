...
from novabot.core import LogManager, novabot_config
from novabot.core.log import LogQueueHandler
...
def _get_trace_logger():
    ...
    _trace_logger = logging.getLogger("novabot.trace")
    return _trace_logger
...
class TraceSpan:
    ...
    def record(self, action: str, **fields: Any) -> None:
        ...
        if not novabot_config.get("trace_enable", True):
            return
