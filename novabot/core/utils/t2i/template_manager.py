# novabot/core/utils/t2i/template_manager.py
...
from novabot.core.utils.novabot_path import get_novabot_data_path, get_novabot_path
...
class TemplateManager:
    ...
    CORE_TEMPLATES = [
        "base.html",
        "novabot_powershell.html",
        "novabot_vitepress.html",
    ]
    ...
    def __init__(self) -> None:
        ...
        self.user_template_dir = os.path.join(get_novabot_data_path(), "t2i_templates")
