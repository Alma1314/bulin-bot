...
class StorageCleaner:
    ...
    def __init__(
        ...
        *,
        ...
        self._config = config
        self._data_dir = data_dir or Path(get_novabot_data_path())
        self._temp_dir = temp_dir or Path(get_novabot_temp_path())
        ...
        return [
            LogFileConfig(
                path=self._resolve_log_path(
                    ...
                    default_relative_path="logs/novabot.log",
                ),
            ...
            LogFileConfig(
                path=self._resolve_log_path(
                    ...
                    default_relative_path="logs/novabot.trace.log",
                ),
