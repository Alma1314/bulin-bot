...
from novabot.core.pipeline.context_utils import call_event_hook
from novabot.core.star.star_handler import EventType


class MainAgentHooks(BaseAgentRunHooks[NovaAgentContext]):
    async def on_agent_begin(
        self, run_context: ContextWrapper[NovaAgentContext]
    ) -> None:
...
class EmptyAgentHooks(BaseAgentRunHooks[NovaAgentContext]):
    pass
