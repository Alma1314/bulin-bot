...
@click.group()
@click.version_option(__version__, prog_name="NovaBot")
def cli() -> None:
    """The NovaBot CLI"""
    click.echo(logo_tmpl)
    click.echo("Welcome to NovaBot CLI!")
    click.echo(f"NovaBot CLI version: {__version__}")
