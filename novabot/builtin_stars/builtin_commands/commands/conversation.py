...
from novabot.api import sp, star
...
from novabot.core.agent.runners.deerflow.deerflow_api_client import DeerFlowAPIClient
...
class ConversationCommands:
    ...
    async def reset(self, message: NovaMessageEvent) -> None:
        ...
        plugin_config = alter_cmd_cfg.get("novabot", {})
