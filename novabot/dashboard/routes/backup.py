...
from novabot.core.backup.importer import NovaBotImporter
...
from novabot.core.utils.novabot_path import (
    get_novabot_backups_path,
    get_novabot_data_path,
)

from .chat import ProgressTracker
...
class BackupRoute(Route):
    ...
    def __init__(
        ...
        self.backup_dir = get_novabot_backups_path()
        self.data_dir = get_novabot_data_path()
        ...
        try:
            with zipfile.ZipFile(zip_path, "r") as zf:
                if "manifest.json" in zf.namelist():
                    ...
                    # 没有 manifest.json，不是有效的 NovaBot 备份
                    return None
        except Exception as e:
    ...
    async def list_backups(self):
        ...
        try:
            ...
            for filename in os.listdir(self.backup_dir):
                ...
                # 如果返回 None，说明不是有效的 NovaBot 备份，跳过
                ...
                backup_files.append(
                    {
                        ...
                        "novabot_version": manifest.get("novabot_version", "未知"),
    ...
    async def export_backup(self):
        ...
        try:
            ...
            # 初始化任务状态
            self.progress.init_task(task_id, type="export")
    ...
    async def _background_export_task(self, task_id: str) -> None:
        """后台导出任务"""
        try:
            self.progress.update_progress(task_id, status="processing", message="正在初始化...")
            ...
            # 创建进度回调
            progress_callback = self.progress.make_callback(task_id)
            ...
            logger.error(traceback.format_exc())
            self.progress.set_result(task_id, "failed", error=str(e))
    ...
    async def import_backup(self):
        ...
        try:
            ...
            # 初始化任务状态
            self.progress.init_task(task_id, type="import")
    ...
    async def get_progress(self):
        ...
        try:
            ...
            task_info = self.progress.get_task(task_id)
