...
from novabot.core.agent.mcp_client import MCPTool, validate_mcp_stdio_config
from novabot.core.core_lifecycle import NovaBotCoreLifecycle
from novabot.core.star import star_map
from novabot.core.tools.registry import get_builtin_tool_config_statuses
...
class ToolsRoute(Route):
    ...
    async def get_tool_list(self):
        ...
        try:
            ...
            config_entries = []
            for conf_id, conf in self.core_lifecycle.novabot_config_mgr.confs.items():
