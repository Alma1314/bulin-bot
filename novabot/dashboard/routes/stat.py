...
from novabot.core import DEMO_MODE, logger
...
from novabot.core.db.migration.helper import check_migration_needed_v4
...
class StatRoute(Route):
    ...
    async def is_default_cred(self):
        ...
        return (
            username == "novabot" and is_default_dashboard_password(password)
        ) and not DEMO_MODE
    ...
    async def test_ghproxy_connection(self):
        ...
        try:
            ...
            test_url = f"{proxy_url}/https://github.com/NovaBotDevs/NovaBot/raw/refs/heads/master/.python-version"
    ...
    async def get_first_notice(self):
        try:
            ...
            base_path = Path(get_novabot_path())
