...
from novabot.core.utils.novabot_path import get_novabot_data_path, get_novabot_temp_path
from novabot.core.utils.datetime_utils import to_utc_isoformat

from .chat import (
    ATTACHMENT_PREFIX_MAP,
        ...
        try:
            ...
            while True:
                ...
                if msg_type == "plain":
                    ...
                    filename = str(result_text).replace(prefix, "").split("|", 1)[0]
                ...
                # live_chat 额外排除 agent_stats (因为已单独渠道发送)
                if should_save and chain_type == "agent_stats":
                    should_save = False
