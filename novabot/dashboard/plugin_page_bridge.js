(function attachNovaBotPluginPageBridge() {
  const CHANNEL = "novabot-plugin-page";
  ...
  function notifyContextHandlers() {
    contextHandlers.forEach((handler) => {
      try {
        ...
        console.error("NovaBotPluginPage context handler failed:", error);
      }
    });
  }
