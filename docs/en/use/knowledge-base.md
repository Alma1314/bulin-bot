...
![Knowledge Base Preview](https://files.novabot.app/docs/en/use/image-3.png)
...
![image](https://files.novabot.app/docs/source/images/knowledge-base/image.png)
...
![Upload Files](https://files.novabot.app/docs/en/use/image-4.png)
