...
![Create Misskey Platform Adapter](https://files.novabot.app/docs/source/images/misskey/create.png)
...
![Misskey Platform Adapter Configuration](https://files.novabot.app/docs/source/images/misskey/config.png)
...
![Open Misskey Connected Services Page](https://files.novabot.app/docs/source/images/misskey/pat-1.png)

2. Click "Generate Access Token" to generate an account access token.

![Generate Misskey Account Token](https://files.novabot.app/docs/source/images/misskey/pat-2.png)
...
![Configure Access Token Permissions](https://files.novabot.app/docs/source/images/misskey/pat-3.png)
...
![View Account Token](https://files.novabot.app/docs/source/images/misskey/pat-4.png)
...
![Demo Example](https://files.novabot.app/docs/source/images/misskey/demo.png)
...
![This is a bot account](https://files.novabot.app/docs/source/images/misskey/botset.png)
