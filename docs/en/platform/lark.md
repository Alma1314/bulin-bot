...
![Create Custom Enterprise Application](https://files.novabot.app/docs/source/images/lark/image.png)

Add the Bot capability to your application.

![Add Bot Capability](https://files.novabot.app/docs/source/images/lark/image-1.png)

Click on "Credentials & Basic Info" to obtain your app_id and app_secret.

![Get app_id and app_secret](https://files.novabot.app/docs/source/images/lark/image-4.png)
...
![Configure Events & Callbacks](https://files.novabot.app/docs/source/images/lark/image-6.png)
...
![Add Event](https://files.novabot.app/docs/source/images/lark/image-7.png)

Click to enable the following permissions.

![Enable Permissions](https://files.novabot.app/docs/source/images/lark/image-8.png)
...
![Final Permissions](https://files.novabot.app/docs/source/images/lark/image-11.png)

## Creating a Version

Create a new version.

![Create Version](https://files.novabot.app/docs/source/images/lark/image-2.png)
...
![Add Bot](https://files.novabot.app/docs/source/images/lark/image-9.png)

## 🎉 All Done!

Send a `/help` command in the group, and the bot will respond.

![Success](https://files.novabot.app/docs/source/images/lark/image-13.png)
