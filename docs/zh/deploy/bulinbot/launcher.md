...
0. 打开 [NovaBotDevs/nova-bot-launcher](https://github.com/NovaBotDevs/nova-bot-launcher)
1.  **(可选但推荐)** 给本项目点个 [**Star ⭐**](https://github.com/NovaBotDevs/nova-bot-launcher)，你的支持是作者更新和维护的动力！
...
打开 https://github.com/NovaBotDevs/NovaBotLauncher/releases/latest 
...
脚本将自动检测目录下是否有 `NovaBot` 文件夹，如果没有，将会从 [GitHub](https://github.com/NovaBotDevs/NovaBot/releases/latest) 自动下载最新的 NovaBot 源码。下载好后，会自动安装 NovaBot 的依赖并运行。
...
>
> **当管理面板打开时遇到 404 错误：**
> 在 [release](https://github.com/NovaBotDevs/NovaBot/releases) 页面下载dist.zip，解压拖到 NovaBot/data 下。还不行请重启电脑（来自群里的反馈）
