...
NovaBot 已经上架至雨云的预装软件列表，支持**一键安装** NovaBot 并提供高性能的云计算资源，保证 `NovaBot` 24 小时在线。
...
2. 根据你的喜好和预算，选择一个合适的服务器配置。建议选择 至少 2 核 CPU、4GB 内存的服务器，以确保 NovaBot 的流畅运行。
...
雨云支持更加优惠的云应用部署方式来一键部署 NovaBot。点击以下图标来部署：
